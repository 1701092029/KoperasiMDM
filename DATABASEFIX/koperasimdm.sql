...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 04, 2021 at 10:48 AM
...
('A001', 2, 'Herri', 'L', 'Komplek Wisma Buana Indah III Blok C4, Kelurahan Korong Gadang, Kecamatan Kuranji', 'Dosen', '081266326515', 'herri_63@gmail.com', '', '', 1),
...
CREATE TABLE `simpanan` (
  `id` int(11) NOT NULL,
  `id_anggota` varchar(20) CHARACTER SET utf8 NOT NULL,
...
(1, 'Admin KMDM', 'satriarahmatputra@gmail.com', 'default.png', '$2y$10$7CcsUBRRElCb7Ap50xEwG.jjxp9OgRM9dpu2kiaeuArSCQuAiDlIi', 1, 1, 1598943893),
...
(19, 10, 'coba1', 'coba/coba', 'fas fa-fw fa-folder', 1),
...
--
-- Indexes for table `history_trans`
--
ALTER TABLE `history_trans`
  ADD PRIMARY KEY (`id`),
  ADD KEY `history_trans_ibfk_1` (`id_trans`);
...
ALTER TABLE `transaksi`
  ...
  ADD KEY `transaksi_ibfk_1` (`kas_keluar`),
  ADD KEY `transaksi_ibfk_2` (`kas_masuk`);
...
--
-- AUTO_INCREMENT for table `history_trans`
--
ALTER TABLE `history_trans`
...
--
ALTER TABLE `anggota`
  ADD CONSTRAINT `anggota_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `berita`
--
ALTER TABLE `berita`
  ADD CONSTRAINT `berita_ibfk_1` FOREIGN KEY (`kategori`) REFERENCES `kategori_berita` (`id_kategori`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `history_trans`
--
ALTER TABLE `history_trans`
  ADD CONSTRAINT `history_trans_ibfk_1` FOREIGN KEY (`id_trans`) REFERENCES `transaksi` (`id_trans`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `user_access_menu`
  ...
  ADD CONSTRAINT `user_access_menu_ibfk_2` FOREIGN KEY (`role_id`) REFERENCES `user_role` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
