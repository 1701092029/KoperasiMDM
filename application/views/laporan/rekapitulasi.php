...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Rekap Data Tahunan</h6>
    </div>
    <div class="card-body">
        <div>
            &nbsp;<a target="_blank" href="<?= base_url(); ?>c_laporan/cetak_Rekap" class="btn btn-danger mb-3"><i class="fa fa-print"></i> Cetak</a>
        </div>
        <?php $start = 1;
        // $list_blnth;
        ...
        <?php foreach ($list_th as $listth) : ?>
            ...
            <div class="table-responsive">
                <table class="table table-hover text-gray-800" width="100%" cellspacing="0">
